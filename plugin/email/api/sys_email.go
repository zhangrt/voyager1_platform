...
import (
	...
	email_response "github.com/zhangrt/voyager1_platform/plugin/email/model/response"
	"github.com/zhangrt/voyager1_platform/plugin/email/service"
...
func (s *EmailApi) EmailTest(c *gin.Context) {
	if err := service.ServiceGroupApp.EmailTest(); err != nil {
		global.GS_LOG.Error("发送失败!", zap.Error(err))
